...
// The OS password to use for WinRM
variable "os_password" {
  type = string
  description = "The OS password to use for WinRM"
}

// The OS username to use for WinRM
variable "os_user" {
  type = string
...
source "vsphere-iso" "ws2019" {
  ...
  iso_paths    = [ 
      "[DATASTORE_NAME] PATH/TO/ISO/SW_DVD9_Win_Server_STD_CORE_2019_1809.15_64Bit_English_DC_STD_MLF_X22-64557.ISO",
...
build {
  ...
  sources = ["source.vsphere-iso.ws2019"]
